/**************************************************************************************************
 ...
 @File   : [ MatrixDX.cpp ] 一般的な4x4の行列 Matrix クラスの定義
 @Auther : Unisawa
...
Matrix Matrix::Inverse()
{
    ...
    D3DXMatrixInverse(&pOut, NULL, this);
...
{
    D3DXMatrixRotationYawPitchRoll(this, Vec.y, Vec.x, Vec.z);
}
...
/*===============================================================================================* 
  ...
  @Details: None
 *===============================================================================================*/
void Matrix::GetRoll(float x)
{
    D3DXMatrixRotationX(this, x);
}
...
/*===============================================================================================* 
  ...
  @Details: None
 *===============================================================================================*/
void Matrix::GetPitch(float y)
{
    D3DXMatrixRotationY(this, y);
}
...
/*===============================================================================================* 
  ...
  @Details: None
 *===============================================================================================*/
void Matrix::GetYaw(float z)
{
    D3DXMatrixRotationZ(this, z);
}
